...
const STAGES = [
  { to: '/console/recon',      icon: Radar,      label: 'Recon Engine',    num: '01', status: 'done' },
  { to: '/console/bugfinding', icon: Bug,         label: 'Bug Finding',     num: '02', status: 'done' },
  { to: '/console/verifier',   icon: ShieldCheck, label: 'PoV Verifier',    num: '03', status: 'done' },
  { to: '/console/vulndna',    icon: Dna,         label: 'VulnDNA',         num: '04', status: 'done' },
  { to: '/console/patch',      icon: Wrench,      label: 'Patch Engine',    num: '05', status: 'running' },
  { to: '/console/report',     icon: FileText,    label: 'Security Report', num: '06', status: 'pending' },
];
    ...
    <aside className="sb">
      ...
      <div className="sb__status-bar">
        <div className="sb__status-row">
          ...
          <span className="sb__status-text">Pipeline Active</span>
        </div>
      </div>
      ...
      <nav className="sb__nav">
        ...
        {STAGES.map(({ to, icon: Icon, label, num, status }) => {
